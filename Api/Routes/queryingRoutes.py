...
async def search_tenders(query: str, top_k: int = Query(10, description="Number of top results to return"),
                     ...
                     bid_start_min: str = Query('01-Jan-1970 12:00 AM', description="Minimum bid submission start date in the format('01-Jan-1970 12:00 AM')"),
                     bid_start_max: str = Query('31-Dec-9999 12:00 AM', description="Maximum bid submission start date in the format('01-Jan-1970 12:00 AM')"),
                     bid_end_min: str = Query('01-Jan-1970 12:00 AM', description="Minimum bid submission end date in the format('01-Jan-1970 12:00 AM')"),
                     bid_end_max: str = Query('31-Dec-9999 12:00 AM', description="Maximum bid submission end date in the format('01-Jan-1970 12:00 AM')")):
